...
local function GetURL(scripturl)
	if shared.VapeDeveloper then
		...
		return game:HttpGet("https://raw.githubusercontent.com/OpaiForRoblox/TapewareV4ForRoblox/main/"..scripturl, true)
	end
end
...
local function getcustomassetfunc(path)
	if not betterisfile(path) then
		...
		local req = requestfunc({
			Url = "https://raw.githubusercontent.com/OpaiForRoblox/TapewareV4ForRoblox/main/"..path:gsub("vape/assets", "assets"),
			Method = "GET"
		})
...
spawn(function()
	local url = "https://raw.githubusercontent.com/OpaiForRoblox/TapewareV4ForRoblox/main/CustomModules/bedwarsdata"
